...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://id.nhent.ai"));
            startActivity(browserIntent);
        } else if (id == R.id.nav_send) {
            Toast.makeText(this, "Developing feature", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_github) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://nhent.ai/app/android/"));
            startActivity(browserIntent);
        }
